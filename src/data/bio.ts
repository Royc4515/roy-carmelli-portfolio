...
export const skills = [
  ...
  { category: "AI & Agents",      items: ["Claude API", "Gemini API", "Groq API", "MCP", "Agentic Workflows", "Prompt Engineering", "Serverless Functions", "Telegram Bot API"] },
  { category: "Data & Neuro",     items: ["NumPy", "Pandas", "SciPy", "Matplotlib", "Jupyter"] },
  { category: "CS Foundations",   items: ["OOP", "Data Structures", "Algorithms", "Design Patterns", "Systems Programming"] },
  { category: "Tools",            items: ["Git", "VS Code", "IntelliJ", "PyCharm", "CLion", "Vercel", "Render", "GitHub Pages"] },
  { category: "Certifications",   items: ["Claude Code in Action", "Claude Code 101", "Claude 101"] },
];
