...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: "Full-stack web app: Google OAuth login → 5-question quiz → AI-generated career portrait via Pollinations.ai with 100+ unique outcomes. Built to learn OAuth flows, session management, and client-server architecture from scratch. React 19/Vite/Tailwind frontend, Node/Express + Passport.js backend, SQLite persistence — production-deployed on Render.",
  ...
  },
  {
    id: "sommelier-bot",
    title: "Sommelier Bot",
    description: "Serverless Telegram bot: AI wine sommelier that pairs meal selections with live wine inventory managed via Google Sheets. Webhook-driven Python on Vercel — stateless by design. Resilient AI pipeline with exponential backoff and automatic LLM fallback chain for API resiliency. Includes a unittest suite covering all API boundaries.",
